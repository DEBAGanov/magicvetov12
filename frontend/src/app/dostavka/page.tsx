...
export const metadata: Metadata = {
  ...
  description: "Доставка цветов по Зеленодольску, Волжску и Казани. Бесплатная доставка при заказе от 3000 ₽. Срочная доставка за 2 часа. Фото перед отправкой.",
  keywords: ["доставка цветов условия", "стоимость доставки цветов", "зоны доставки цветов зеленодольск"],
