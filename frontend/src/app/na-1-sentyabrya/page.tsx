...
export const metadata: Metadata = {
  title: "Цветы на 1 сентября — букеты для учителей | Волжск, Зеленодольск",
  description:
    "Букеты цветов на 1 сентября с доставкой по Волжску и Зеленодольску. Гладиолусы, астры, хризантемы для учителей.",
  keywords: [
