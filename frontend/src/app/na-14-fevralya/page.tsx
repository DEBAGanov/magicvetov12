...
export const metadata: Metadata = {
  ...
  description:
    "❤️ Красные розы и романтические букеты на 14 февраля! Доставка по Зеленодольску и Волжску. Закажите букет для любимой с открыткой.",
  keywords: [
    "цветы на 14 февраля", "букет на 14 февраля", "розы на 14 февраля",
    "день святого валентина цветы", "14 февраля доставка цветов",
    "красные розы 14 февраля", "романтический букет",
  ],
  openGraph: {
    title: "Цветы на 14 февраля — доставка букетов | Магия Цветов",
    description: "❤️ Розы и романтические букеты на 14 февраля! Доставка за 2 часа.",
    locale: "ru_RU",
    type: "website",
  },
