...
export const metadata: Metadata = {
  title: "Цветы на 8 марта — букеты с доставкой | Волжск, Зеленодольск",
  description:
    "Закажите букет цветов на 8 марта с доставкой по Волжску и Зеленодольску. Тюльпаны, розы, мимоза и весенние букеты.",
  keywords: [
