...
export const metadata: Metadata = {
  ...
  description: "Свяжитесь с Магией Цветов! Телефон: +7 (964) 861-23-70. Доставка цветов по Зеленодольску, Волжску и Казани. Работаем ежедневно.",
  keywords: ["магия цветов контакты", "цветочный магазин телефон волжск", "адрес магазина цветов зеленодольск"],
      ...
      <div className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="rounded-xl overflow-hidden min-h-[400px] relative">
            <iframe
              src="https://yandex.ru/map-widget/v1/?z=17&ol=biz&oid=174166621256"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
