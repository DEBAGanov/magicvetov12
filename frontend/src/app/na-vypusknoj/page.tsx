...
export const metadata: Metadata = {
  title: "Цветы на выпускной и последний звонок — доставка букетов | Магия Цветов",
  description:
    "🎓 Букеты на выпускной и последний звонок с доставкой по Зеленодольску и Волжску! Яркие букеты для выпускников и учителей от 990 ₽.",
  keywords: [
    "цветы на выпускной", "цветы на последний звонок", "букет на выпускной",
    "цветы учителю", "выпускной букет", "последний звонок цветы",
    "букет учителю зеленодольск", "цветы на выпускной волжск",
  ],
  openGraph: {
    title: "Цветы на выпускной с доставкой | Магия Цветов",
    description: "🎓 Букеты для выпускников и учителей с доставкой за 2 часа!",
    locale: "ru_RU",
    type: "website",
  },
