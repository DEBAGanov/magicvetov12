...
import { JsonLd, floristSchema, websiteSchema, faqSchema } from "@/components/seo/JsonLd";
...
export default async function HomePage() {
  ...
  return (
    <>
      <JsonLd data={[floristSchema(), websiteSchema(), faqSchema([...FAQ.general])]} />
      <HeroBanner />
      <DeliveryInfo />
      ...
      <section className="bg-gradient-to-r from-primary-500 to-primary-600 text-white text-center py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold mb-2">Подарите радость близким в Волжске и Зеленодольске</h2>
