...
export const metadata: Metadata = {
  title: "О нас — Магия Цветов | Волжск, Зеленодольск",
  description: "Цветочный магазин «Магия Цветов» — доставка свежих цветов по Волжску и Зеленодольску. Наша история, команда и гарантии качества.",
